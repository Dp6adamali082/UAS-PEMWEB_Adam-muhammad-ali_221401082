...
if (isset($_SESSION["login"])) {
    header("location: Code/product/product.php");
    exit();
}
...
<head>
    ...
    <link rel="stylesheet" href="Code/style/style_index.css">
...
<body class="body-home">
    ...
    <header class="header-container" id="home-top">
        <nav class="wrapper">
            ...
            <div class="right-side" id="rightSide">
                ...
                <ul class="navigation">
                    ...
                    <button class="nav-login-butt"><a href="Code/LoginReg/login.php">Login</a></button>
                </ul>
            </div>
        ...
        <div class="welcome-text-wrapper">
            <div class="welcome-text">
                ...
                <a href="Code/LoginReg/login.php"><button class="hero-butt">Beli Produk Kami</button></a>
            </div>
        </div>
    </header>
    ...
    <div class="card-container">
        <div class="card">
            <div class="img-wrap">
                <a href="Code/LoginReg/login.php"><img src="Assets/ml.jpg" class="card-pict"><i class="fa fa-sign-in" style="font-size:50px; color: #5adeff;"></i></a>
            </div>
        ...
        <div class="card">
            <div class="img-wrap">
                <a href="Code/LoginReg/login.php"><img src="Assets/roblox.jpeg" class="card-pict"><i class="fa fa-sign-in" style="font-size:50px; color: #5adeff;"></i></a>
            </div>
            <div class="card-content">
                <h2>Roblox</h2>
        ...
        <div class="card">
            <div class="img-wrap">
                <a href="Code/LoginReg/login.php"><img src="Assets/valorant.jpg" class="card-pict"><i class="fa fa-sign-in" style="font-size:50px; color: #5adeff;"></i></a>
            </div>
            <div class="card-content">
                <h2>Valorant</h2>
        ...
        <div class="card">
            <div class="img-wrap">
                <a href="Code/LoginReg/login.php"></a><img src="Assets/cs.jpg" class="card-pict"><i class="fa fa-sign-in" style="font-size:50px; color: #5adeff;"></i></a>
            </div>
            <div class="card-content">
    ...
    <div class="pc-container">
        <div class="promo-card">
            <div class="tulisan-pc">
                ...
                <a href="Code/LoginReg/login.php"><button class="tombol-pc">Gass!</button></a>
            </div>
